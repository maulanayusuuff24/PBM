...
Mobile.tap(findTestObject('Regist New/android.view.ViewGroup - Next 1'), 0)

Mobile.tap(findTestObject('Regist New/android.view.ViewGroup - Next 2'), 0)

Mobile.tap(findTestObject('Object Repository/Login Revamp/android.view.ViewGroup - Masuk'), 0)

Mobile.setText(findTestObject('Object Repository/Login Revamp/android.widget.EditText - Masukkan nomor handphoneemail kamu'), 
    'picuppy11@yopmail.com', 0)

Mobile.tap(findTestObject('Object Repository/Login Revamp/android.widget.TextView - Lanjutkan'), 0)

Mobile.setText(findTestObject('Object Repository/Login Revamp/android.widget.EditText - otp'), '3828', 0)
